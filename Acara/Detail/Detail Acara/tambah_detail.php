...
if (isset($_GET['cookie'])) {
    ...
    // Gunakan nilai cookie sesuai kebutuhan
                ...
                <table class="kegiatan">
                    ...
                    <tr class="prioritas">
                        ...
                        <td>
                            <select id="prioritas" name ="prioritas">
                                <option value="1" disabled selected>Pilih Prioritas</option>
                                <option value="3">Urgent</option>
                                <option value="2">Important</option>
                                <option value="1">Non-Important</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" class="go-back">
                            ...
                            $tanggal_kegiatan = isset($_GET['date']) ? $_GET['date'] : '';
                            ?>
                        <button type="submit" name="submit" style="border: none; background-color: transparent; text-decoration: underline; cursor: pointer;">Submit</button>
                        </td>
